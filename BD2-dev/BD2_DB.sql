...
--mechanik privileges
GRANT SELECT, UPDATE, INSERT, DELETE ON ALL TABLES IN SCHEMA public to mechanik;
GRANT SELECT, UPDATE, INSERT, DELETE ON ALL TABLES IN SCHEMA public to magazynier;