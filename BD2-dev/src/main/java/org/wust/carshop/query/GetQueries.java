...
public class GetQueries {
    ...
    static public final String GET_PART_TYPES = "SELECT nazwa as name FROM typy";

    static public final String GET_TEMPLATE_NAMES = "SELECT nazwa as name FROM szablony_napraw";
    ...
    static public final String GET_PART_BY_ID = """
            SELECT p.id,
             p.numer_seryjny as serial_number,
             p.koszt as price,
             cm.nazwa as car_model,
